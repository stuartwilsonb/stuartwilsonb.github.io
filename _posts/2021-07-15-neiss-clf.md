...
Also, I took a sample of 300,000 random observations from the dataset. This is to save on computation time when fitting models.
...
## accuracy = 0.902, precision = 0.904, recall = 0.902, f1 = 0.897
{% endhighlight %}
...
the vocabulary list, each vector has over 50,000 dimensions. However, we can use perfrom dimensionality-reduction to project the data
...
Another good way to gain insights on one's model is to create a confusion matrix. A confusion matrix is a good way to show how exactly
